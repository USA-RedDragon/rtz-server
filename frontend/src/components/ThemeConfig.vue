...
<template>
  ...
  <Sidebar v-model:visible="visible" position="right" :transitionOptions="'.3s cubic-bezier(0, 0, 0.2, 1)'"
    ...
    <div class="grid">
      <div class="col-3">
        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('luna-amber', 'dark')">
          <img src="/layout/images/themes/luna-amber.png" class="w-2rem h-2rem" alt="Luna Amber" />
        </button>
      </div>
      <div class="col-3">
        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('luna-blue', 'dark')">
          <img src="/layout/images/themes/luna-blue.png" class="w-2rem h-2rem" alt="Luna Blue" />
        </button>
      </div>
      <div class="col-3">
        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('luna-green', 'dark')">
          <img src="/layout/images/themes/luna-green.png" class="w-2rem h-2rem" alt="Luna Green" />
        </button>
      </div>
      <div class="col-3">
        <button class="p-link w-2rem h-2rem" @click="onChangeTheme('luna-pink', 'dark')">
          <img src="/layout/images/themes/luna-pink.png" class="w-2rem h-2rem" alt="Luna Pink" />
        </button>
      </div>
    </div>
