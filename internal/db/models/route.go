...
type Route struct {
	...
	FirstClockWallTimeNanos uint64    `json:"-" binding:"required"`
	FirstClockLogMonoTime   uint64    `json:"-" binding:"required"`
	...
	InitLogMonoTime         uint64    `json:"init_log_mono_time" binding:"required"`
